    ...
    <MainLayout>
      ...
      <Content>
        <Paragraph>
          ...
          두었을 것 같지는 않으나, 그렇다고 해서 야민정음을 보고 꼭 분노했을 것 같지도 않다. ‘아니,
          내가 생각지도 못했던 이런 방식으로 한글을 쓰다니. 요즘 녀석들 아이디어가 톡톡 튀는데.’
          하며 껄껄 웃으실지도 모르겠다. ~" - 박진호 교수(국어국문학과)
